...
assert.match(source, /const CACHE_NAME = 'padoka-pwa-v3'/, 'PWA cache version must be bumped after security-policy changes');
...
for (const page of ['internal.html', 'pedidos.html', 'pdv.html', 'gestao.html', 'mfa.html']) {
